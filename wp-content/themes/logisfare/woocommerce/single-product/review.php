...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
	<?php
            ...
            if ($comment->user_id != '' && $comment->user_id != 0) {
                ...
                if ($avID != '') {
                    $userAvater = logisfare_attachment_url($avID, 90, 90);
                } else {
                    $userAvater = $avater;
                }
            } else {
        ...
        <div class="postReview">
            ...
            <div class="reviewMeta">
                <?php echo get_comment_time('F j, Y'); ?> <span><?php echo esc_html(' - BY ', 'logisfare'); ?></span><?php echo esc_html($comment->comment_author); ?>
            </div>
        </div>
