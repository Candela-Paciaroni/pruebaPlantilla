    ...
    CSF::createSection($section_id, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'dependency' => array('blog_cat_is_banner', '==', 'true'),
            ),
        ),
    ));
    ...
    CSF::createSection($section_id, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'unit'      => 'px',
                'default'   => 295,
                'dependency' => array('blog_cat_view', '==', 1),
            ),
            array(
                'id'        => 'blog_cat_str_limit_grid',
                'type'      => 'slider',
                ...
                'unit'      => 'px',
                'default'   => 90,
                'dependency' => array('blog_cat_view', '==', 2),
            ),
            array(
                'id'      => 'blog_cat_readmore_label',
                'type'    => 'text',
