...
$blog_srch_is_banner        = tw_get_option($customizer_ID, 'blog_srch_is_banner', 1);
$blog_srch_banner_block     = tw_get_option($customizer_ID, 'blog_srch_banner_block', -1);
$blog_pagination_alignment  = tw_get_option($customizer_ID, 'blog_pagination_alignment', 'start');

if($blog_srch_is_banner && $blog_srch_banner_block > 0 && class_exists('THEMEWAR_Assistance')):
    Themewar_Builder::render_template($blog_srch_banner_block);
elseif($blog_srch_is_banner && ($blog_srch_banner_block < 0 || $blog_srch_banner_block == '')):
