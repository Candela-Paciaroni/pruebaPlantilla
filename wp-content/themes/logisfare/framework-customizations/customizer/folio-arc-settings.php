...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Folio Archive Settings', 'logisfare'),
        'priority' => 11,
        'fields' => array(
            ...
            array(
                ...
                'dependency' => array('folio_arc_is_banner', '==', 'true'),
            ),  
