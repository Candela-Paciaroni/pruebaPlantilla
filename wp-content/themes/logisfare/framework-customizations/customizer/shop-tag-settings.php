...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Shop Tag Settings', 'logisfare'),
        'priority' => 18,
        'fields' => array(
            ...
            array(
                ...
                'dependency' => array('shop_tag_is_banner', '==', 'true'),
            ),
            ...
            array(
                ...
                'default'     => '1',
                'dependency' => array('shop_tag_is_view_toggler', '==', 'true'),
            ),
            array(
                'id'      => 'shop_tag_grid_title_length',
                'type'    => 'number',
                'title'   => esc_html__('Grid Title String Limit', 'logisfare'),
                'default' => 28,
                'dependency' => array('shop_tag_default_view', '==', '1'),
            ),
            array(
                'id'      => 'shop_tag_list_desc_length',
                'type'    => 'number',
                'title'   => esc_html__('List Desc String Limit', 'logisfare'),
                'default' => 71,
                'dependency' => array('shop_tag_default_view', '==', '2'),
            ),
            array(
                'id' => 'shop_tag_is_flashlabels',
                'type' => 'switcher',
            ...
            array(
                ...
                'default'     => 'center',
                'dependency' => array('shop_tag_is_pagination', '==', 'true'),
            ),
            array(
                'id'      => 'shop_tag_paging_margin',
                'type'    => 'slider',
                'title'   => esc_html__('Pagination Gapping Y', 'logisfare'),
                'unit'        => 'px',
                'output'      => '.logisfareShopTagPagination',
