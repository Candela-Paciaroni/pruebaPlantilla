...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Shop Settings', 'logisfare'),
        'priority' => 16,
        'fields' => array(
            ...
            array(
                ...
                'dependency' => array('shop_is_banner', '==', 'true'),
            ),
            ...
            array(
                ...
                'default'     => '1',
                'dependency' => array('shop_is_view_toggler', '==', 'true'),
            ),
            array(
                'id'      => 'shop_grid_title_length',
                'type'    => 'number',
                'title'   => esc_html__('Grid Title String Limit', 'logisfare'),
                'default' => 28,
                'dependency' => array('shop_default_view', '==', '1'),
            ),
            array(
                'id'      => 'shop_list_desc_length',
                'type'    => 'number',
                'title'   => esc_html__('List Desc String Limit', 'logisfare'),
                'default' => 71,
                'dependency' => array('shop_default_view', '==', '2'),
            ),
            array(
                'id' => 'shop_is_flashlabels',
                'type' => 'switcher',
            ...
            array(
                'id'      => 'shop_numof_product',
                'type'    => 'slider',
                'title'   => esc_html__('Number Of Products', 'logisfare'),
                'min'     => 3,
                'max'     => 500,
                'step'    => 1,
                'default' => 8,
            ...
            array(
                ...
                'default'     => 'Center',
                'dependency' => array('shop_is_pagination', '==', 'true'),
            ),
            array(
                'id'      => 'shop_paging_margin',
                'type'    => 'slider',
                'title'   => esc_html__('Pagination Gapping Y', 'logisfare'),
                'dependency' => array('shop_is_pagination', '==', 'true'),
                'unit'        => 'px',
                'output'      => '.logisfareShopPagination',
