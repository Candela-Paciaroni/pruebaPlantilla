...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Blog Settings', 'logisfare'),
        'priority' => 4,
        'fields' => array(
            ...
            array(
                ...
                'dependency' => array('blog_is_banner', '==', 'true'),
            ),
            ...
            array(
                ...
                'default'     => '1',
                'dependency' => array('blog_view', '==', '2'),
            ),
            array(
                'id'      => 'blog_title_limit',
                'type'    => 'number',
                'title'   => esc_html__('Title Limit', 'logisfare'),
                'default' => 48,
                'dependency' => array('blog_view', '==', '2'),
            ),
            array(
                ...
                'default' => 295,
                'dependency' => array('blog_view', '==', '1'),
            ),
            array(
                'id'      => 'blog_str_limit_grid',
                'type'    => 'number',
                'title'   => esc_html__('Excerpt Limit', 'logisfare'),
                'default' => 90,
                'dependency' => array(
                    array('blog_view', '==', '2'),
                    array('blog_grid_style', '==', '3'),
                ),
            ),
            array(
            ...
            array(
                'id'      => 'blog_paging_margin',
                'type'    => 'slider',
                'title'   => esc_html__('Pagination Gapping (Y)', 'logisfare'),
                'unit'        => 'px',
                'output'      => '.blogPagePagination .logisfarePagination',
            ...
            array(
                'type'    => 'heading',
                'content' => esc_html__('Blocks Settings', 'logisfare'),
            ),
            array(
                'id'        => 'blog_bloks',
                'type'      => 'repeater',
