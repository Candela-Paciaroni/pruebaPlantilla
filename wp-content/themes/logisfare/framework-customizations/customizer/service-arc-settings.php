...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Service Archive Settings', 'logisfare'),
        'priority' => 13,
        'fields' => array(
            ...
            array(
                'id'          => 'service_arc_style',
                'type'        => 'select',
                'title'       => esc_html__('Service View Style', 'logisfare'),
                'placeholder' => esc_html__('Select Service View', 'logisfare'),
                'options'     => array(
            ...
            array(
                'id'          => 'service_arc_btn_lable',
                'type'        => 'text',
                'label'       => esc_html__( 'Service Btn lable', 'logisfare' ),
                'default'     => esc_html__( 'Learn More', 'logisfare' ),
            ),
            array(
                'id'          => 'service_arc_col_xxl',
                'type'        => 'select',
            ...
            array(
                'id'      => 'service_arc_excerpt_length',
                'type'    => 'slider',
                'title'   => esc_html__('Excerpt String Length', 'logisfare'),
                'desc'    => esc_html__( 'Excerpt String Lemit for Style-01 115 & Style-03 68.', 'logisfare' ),
                'min'     => 0,
                'max'     => 500,
                'step'    => 1,
                'default' => 115,
            ...
            array(
                'id'      => 'service_arc_title_length',
                'type'    => 'slider',
                'title'   => esc_html__('Excerpt Title Length', 'logisfare'),
                'min'     => 0,
                'max'     => 500,
                'step'    => 1,
                'default' => 20,
