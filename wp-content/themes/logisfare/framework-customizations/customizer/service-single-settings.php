...
if (class_exists('CSF')) {
    ...
    CSF::createSection($section_id, array(
        ...
        'title' => esc_html__('Service Single Settings', 'logisfare'),
        'priority' => 12,
        'fields' => array(
            ...
            array(
                'id'        => 'service_single_banner_block',
                'type'      => 'select',
                ...
                'dependency' => array('service_single_is_banner', '==', 'true'),
            ),
