...
if($qp->have_posts()): ?>
    <div class="row blogGridWrapper">
        <?php
            $a = 1;
            while($qp->have_posts()):
                $qp->the_post();
                
                $w = ($lb_post_thumb_width > 0 && !empty($lb_post_thumb_width) ? $lb_post_thumb_width : ($lb_select_pst_style == 2 ? 598 : ($lb_select_pst_style == 3 ? 391 : 391)));
                $h = ($lb_post_thumb_height > 0 && !empty($lb_post_thumb_width) ? $lb_post_thumb_height : ($lb_select_pst_style == 2 ? 400 : ($lb_select_pst_style == 3 ? 314 : 330)));
                ...
                ?>
                    <div class="col-xxl-<?php echo round(12 / $lb_xxl_col); ?> col-xl-<?php echo round(12 / $lb_xl_col); ?> col-lg-<?php echo round(12 / $lb_lg_col); ?> col-md-<?php echo round(12 / $lb_md_col); ?>  col-sm-<?php echo round(12 / $lb_sm_col); ?>">
                        <div class="blogItem03 <?php echo $animClass; ?>" <?php echo $animAttr; ?>>
                ...
                <?php elseif($lb_select_pst_style == 2): ?>
                    <div class="col-xxl-<?php echo round(12 / $lb_xxl_col); ?> col-xl-<?php echo round(12 / $lb_xl_col); ?> col-lg-<?php echo round(12 / $lb_lg_col); ?> col-md-<?php echo round(12 / $lb_md_col); ?>  col-sm-<?php echo round(12 / $lb_sm_col); ?>">
                        <div class="blogItem02 <?php echo $animClass; ?>" <?php echo $animAttr; ?>>
                ...
                <?php else: ?>
                    <div class="col-xxl-<?php echo round(12 / $lb_xxl_col); ?> col-xl-<?php echo round(12 / $lb_xl_col); ?> col-lg-<?php echo round(12 / $lb_lg_col); ?> col-md-<?php echo round(12 / $lb_md_col); ?>  col-sm-<?php echo round(12 / $lb_sm_col); ?>">
                        <div class="blogItem01 <?php echo $animClass; ?>" <?php echo $animAttr; ?>>
