<?php if($is_topbar == 'yes'): ?>
    <section class="topBar01 <?php echo($header_position == 2 ? 'absoluteTopB' : ''); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?php if(!empty($tpbr_info_list)): ?>
                            <div class="topDesc">
                                ...
                                <p>
                                    ...
                                    <?php endif; 
                                    if(!empty($topbar_info_url)): ?>
                                    <a <?php echo esc_attr($target. ' '.$nofollow); ?> href="<?php echo esc_url($topbar_info_url); ?>"><?php endif; ?><?php echo esc_html($topbar_info); ?><?php if(!empty($topbar_info_url)): ?></a><?php endif; ?>
                                </p>
                                <?php $i++; endforeach; ?>
                            </div>
                        <?php endif; ?>
...
<header class="header01 <?php if ($is_sticky == 'yes'): ?>isSticky<?php endif; echo($header_position == 2 ? ' absoluteHeader' : ''); ?>">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="navBar01">
