...
class Themewar_Sidebar_Social_Widgets extends Widget_Base {
    
    public function get_name() {
        return 'themewar-sb-social';
    }
    
    public function get_title() {
        return esc_html__('Social Widget', 'themewar');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'section_tab_2', [
                ...
                $this->add_group_control(Group_Control_Background::get_type(),[
                            ...
                            'selector' => '{{WRAPPER}} .sidebarSocial_widget',
                    ]
                );
                ...
                $this->add_responsive_control( 'fs_item_readius', [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .sidebarSocial_widget' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                    ]
                );
                $this->add_responsive_control( 'fs_item_margin', [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .sidebarSocial_widget' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                    ]
                );
                $this->add_responsive_control( 'fs_item_padding', [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .sidebarSocial_widget' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                    ]
                );
        $this->end_controls_section();
        ...
        $this->start_controls_section('section_tab_3', [
                ...
                $this->add_group_control(Group_Control_Typography::get_type(),[
                            ...
                            'selector'      => '{{WRAPPER}} .sidebarSocial a i',
                    ]
                );
                $this->add_responsive_control('icon_box_width',[
                            ...
                            'selectors' => [
                                    '{{WRAPPER}} .sidebarSocial a' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                    ]
                );
                $this->add_responsive_control('icon_box_height',[
                            ...
                            'selectors' => [
                                    '{{WRAPPER}} .sidebarSocial a' => 'height: {{SIZE}}{{UNIT}};',
                            ],
                    ]
                );
                $this->add_responsive_control('icon_box_border_radius',[
                            ...
                            'size_units'    => [ 'px', '%', 'em' ],
                            'selectors'     => [
                                '{{WRAPPER}} .sidebarSocial a'   => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                    ]
                );
                $this->start_controls_tabs( 'social_styling_tab' );
                    $this->start_controls_tab('social_tab_normal',[
                        ...
                        $this->add_responsive_control('social_icon_color',[
                                    ...
                                    'type'      => Controls_Manager::COLOR,
                                    'selectors' => [
                                            '{{WRAPPER}} .sidebarSocial a'    => 'color: {{VALUE}}',
                                    ],
                            ]
                        );
                        $this->add_group_control( Group_Control_Border::get_type(),[
                                    'name'      => 's_border',
                                    'label'     => esc_html__( 'Border', 'themewar' ),
                                    'selector'  => '{{WRAPPER}} .sidebarSocial a',
                            ]
                        );
                        $this->add_group_control(Group_Control_Box_Shadow::get_type(),[
                                    'name'      => 's_box_shadow',
                    ...
                    $this->start_controls_tab('social_tab_hover',[
                        ...
                        $this->add_responsive_control( 'social_icon_hover_color',[
                                    ...
                                    'type'      => Controls_Manager::COLOR,
                                    'selectors' => [
                                            '{{WRAPPER}} .sidebarSocial a:hover'    => 'color: {{VALUE}}',
                                    ],
                            ]
                        );
                        $this->add_responsive_control( 'social_hover_bg_hr',[
                                    ...
                                    'type'      => Controls_Manager::COLOR,
                                    'selectors' => [
                                            '{{WRAPPER}} .sidebarSocial a:hover'    => 'background: {{VALUE}} !important',
                                    ],
                            ]
                        );
                        $this->add_group_control(Group_Control_Border::get_type(),[
                                    'name'      => 's_hover_border',
                                    'label'     => esc_html__( 'Border', 'themewar' ),
                                    'selector'  => '{{WRAPPER}} .sidebarSocial a:hover',
                            ]
                        );
                        $this->add_group_control(Group_Control_Box_Shadow::get_type(),[
                ...
                $this->add_responsive_control('tags_items_col_gap', [
                            ...
                            'default' => [],
                            'selectors' => [
                                '{{WRAPPER}} .sidebarSocial' => 'column-gap: {{SIZE}}{{UNIT}};',
                            ],
                    ]
                );
                $this->add_responsive_control('tags_items_rpw_gap', [
                            ...
                            'default' => [],
                            'selectors' => [
                                '{{WRAPPER}} .sidebarSocial' => 'row-gap: {{SIZE}}{{UNIT}};',
                            ],
                    ]
                );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        ?>
        <div class="sidebarSocial_widget widget <?php echo $animClass; ?>" <?php echo $animAttr; ?>>
                ...
                <?php 
                    if(!empty($s_list)):
                        foreach($s_list as $sl):
                            ...
                            if($s_icons != ''):
                            ?>
                            <a class="social-icon-link" style="background:<?php echo esc_attr($s_icon_color); ?>"  <?php echo esc_attr($target.' '.$nofollow); ?> href="<?php echo $s_url; ?>">
