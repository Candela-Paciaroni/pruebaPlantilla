...
class Themewar_Rev_Slider_Widgets extends Widget_Base {

    public function get_name() {
        return 'themewar-rev-slider';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
                ...
                [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors'  => [
                            '{{WRAPPER}} .themewar_rev_slider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                ]
        );
        $this->add_responsive_control(
                ...
                [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors'  => [
                            '{{WRAPPER}} .themewar_rev_slider' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                ]
        );
        $this->add_group_control(
                ...
                [
                        ...
                        'selector'  => '{{WRAPPER}} .themewar_rev_slider',
                ]
        );
        $this->add_responsive_control(
            'ab_img_radius',
            [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .themewar_rev_slider'   => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        if($rev_alise != ''){ ?>
            <section class="themewar_rev_slider">
