...
/**
 * Class Themewar_Assistance_Helpers
 */
class Themewar_Assistance_Helpers
{
    /* * ---------------------------------------------------------------
    ...
    * -------------------------------------------------------------* */
    /**
     * Themewar_Assistance_Helpers constructor.
     */
    public function __construct()
    {
        add_action('wp_ajax_themewar_get_taxonomy', array($this, 'themewar_get_taxonomy'));
        add_action('wp_ajax_nopriv_themewar_get_taxonomy', array($this, 'themewar_get_taxonomy'));

        add_action('wp_ajax_themewar_get_post', array($this, 'themewar_get_post'));
        add_action('wp_ajax_nopriv_themewar_get_post', array($this, 'themewar_get_post'));
    }
     ...
     * Get taxonomy
     */
    public function themewar_get_taxonomy()
    {
        $args = array(
            'orderby' => 'name',
            'order' => 'DESC',
     ...
     * Get Post
     */
    public function themewar_get_post()
    {
        global $wpdb;
